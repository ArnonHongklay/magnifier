...
## 0.3.0
 - move the user_id column from Bloggy::PostRevision to Bloggy::Post.
 - Portuguese, Italian and Spanish translations were added! You can now use Bloggy in either French, English, Romanian, Portuguese, Italian and Spanish
 - Remove revisions
 - Preview using Ajax
 - User management
 - bug fixes & cleanup
...
## 0.2.0
 ...
 - Romanian translations were added, thanks to [mixandgo](https://github.com/mixandgo). You can now use Bloggy in either French, English or Romanian!
 - few bug fixes

## 0.2.0.beta
- **IMPORTANT: add cache management config and UI. [Please review the new config options](https://github.com/jipiboily/bloggy/wiki/Configure-Bloggy's-cache)!**
- first extension available: [bloggy-markdown](https://github.com/jipiboily/bloggy-markdown)
- add tags
...
- a few [Deface](https://github.com/spree/deface) hooks (data-bloggy attribute) were added to the admin layout (for the menu)
- update admin UI with newest Twitter Boostrap (v2.1.1)
- visual look has been slightly updated **(Hey, designers, want to help on Bloggy next design? You're "hired"!)**  [Preview](http://screencast.com/t/6Ua49p2TdqP)
...
- changed URL pattern, now without mount point (say "/" or "/blog") (fix for https://github.com/jipiboily/bloggy/issues/64 by https://github.com/jipiboily/bloggy/issues/59);
- you can now use your main_app layout with Bloggy (https://github.com/jipiboily/bloggy/issues/54) (use config: Bloggy.layout. See wiki for more information/example);
