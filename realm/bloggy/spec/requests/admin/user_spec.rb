...
describe "users" do
  ...
  it "make sure the link to user edit screen is present", js: true, driver: :webkit do
    click_link I18n.t("layouts.bloggy.admin.nav_bar.edit_user_info")
  end
  ...
  context "edit" do
    ...
    it "validates user password and confirmation match" do
      ...
      click_button "Save"
      page.should have_content(I18n.t("activerecord.errors.models.bloggy/user.attributes.password.confirmation"))
    end

    it "doesn't change password if none is provided" do
      password_before = ::Bloggy::User.find_by_email(user.email).password_digest
      click_button "Save"
      ::Bloggy::User.find_by_email(user.email).password_digest.should eq(password_before)
    end
  end
  ...
  context "Logged in" do
    ...
    it "should be able to create a new user" do
      visit admin_users_path
      click_on I18n.t("bloggy.admin.users.index.create")
      fill_in "user_name", with: "John"
      fill_in "user_email", with: "john@doe.com"
      fill_in "user_password", with: "password"
      fill_in "user_password_confirmation", with: "password"
      click_button I18n.t("bloggy.admin.users.new.create")
      page.should have_content(I18n.t("bloggy.admin.users.create.success"))
    end

    it "should not be able to delete user with posts" do
      visit admin_users_path
      delete= I18n.t("bloggy.admin.users.index.delete")
