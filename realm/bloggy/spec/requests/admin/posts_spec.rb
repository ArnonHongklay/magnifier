...
describe "posts" do
  context "logged in user" do
    ...
    it "can create new post" do
      ...
      page.should have_content "New bloggy"
      ...
      click_button "Save"
      page.should have_content "Bloggy created"
    end
    ...
    it "can edit a post and then save the post" do
      ...
      fill_in "Published at", with:  DateTime.now
      click_button "Save"
      page.should have_content "Bloggy saved"
    end
