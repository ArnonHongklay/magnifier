...
FactoryGirl.define do
  factory :post, class: Bloggy::Post do
    published true
    association :user
  ...
  factory :unpublished_post, class: Bloggy::Post, parent: :post do |post|
    published false
    title "unpublished"
    url "unpublished"
  end

  factory :post_with_tags, class: Bloggy::Post, parent: :post do |post|
